...
This card analyses the environment in which Pythagoras is running. This can be useful in explaining differences in the reproduction of past results. If you refresh the card at a later time there may be additional packages loaded as many are loaded dynamically on-demand.
...
#### 🎯 Goals
 ...
 1. _Primary:_ Document the package versions in use
 1. _Secondary:_ Provide evidence about changes
