...
The card's front shows a drag & drop dialogue for assigning the variables to roles. The full-screen mode makes the process easier.
...
#### 🎯 Goals
 ...
 1. _Primary:_ Identify which single roles should be assigned to each variable.
 1. _Secondary:_ Validate that each variable's data-type, cardinality, and missing values are appropriate for the assigned role.
