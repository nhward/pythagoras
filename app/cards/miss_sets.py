...
def instance():
    ...
    def settings():
        return ui.TagList(
            ui.input_slider(
                id="MaxIntersections",
                label="Maximum intersections to chart",
                min=5,
                max=100,
                value=40,
                step=1,
                guide=this,
                text="Limits the top missingness combinations shown in the chart and table.",
                position="left",
            ),
            ui.input_slider(
                id="MaxVariables",
                label="Maximum variables to chart",
                min=2,
                max=30,
                value=15,
                step=1,
                guide=this,
                text="Keeps the most frequently missing variables when the data has many incomplete columns.",
                position="left",
            ),
            ui.input_numeric(
                id="MinCount",
                label="Minimum observations per intersection",
                value=1,
                min=1,
                step=1,
                guide=this,
                text="Hides exact missingness combinations occurring fewer times than this threshold.",
                position="left",
            ),
            ui.input_slider(
                id="MaxObs",
                ...
                pre="10^",
                guide=this,
                text="Limits observations by random sampling to ensure responsiveness.",
                position="left",
            ),
        )
